...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("HXVis", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("HXVis", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "60";
		app.meta["company"] = "CoreCat";
		app.meta["file"] = "HXVis";
		app.meta["name"] = "AudVis";
		app.meta["packageName"] = "com.core5570r.audvis";
