...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Calculator", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Calculator", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "3";
		app.meta["company"] = "";
		app.meta["file"] = "Calculator";
		app.meta["name"] = "Calculator";
		...
		#elseif !air
		app.window.context.attributes.background = 2236962;
